...
package com.garfty.asteroids.bootstrap.utils
{
  ...
  public class ApplicationBootstrapConstants
  {
    ...
    public static const REGISTER_APPLICATION_SINGLETONS:String = 'event/robotlegs/registerApplicationCommandsSingletons';
    public static const REGISTERING_APPLICATION_SINGLETONS:String = 'state/robotlegs/registeringApplicationSingletons';
    public static const REGISTER_APPLICATION_SINGLETONS_COMPLETE:String = 'actions/robotlegs/registerApplicationSingletonsComplete';
    public static const REGISTER_APPLICATION_SINGLETONS_ERROR:String = 'actions/robotlegs/registerApplicationSingletonsError';
    ...
    private static const APPLICATION_BOOTSTRAP:XML =
            <fsm>
              ...
              <state name={REGISTERING_APPLICATION_COMMANDS} changed={REGISTER_APPLICATION_COMMANDS}>
                <transition action={REGISTER_APPLICATION_COMMANDS_COMPLETE} target={REGISTERING_APPLICATION_SINGLETONS} />
                <transition action={REGISTER_APPLICATION_COMMANDS_ERROR} target={STARTUP_FAILING} />
              </state>
              <state name={REGISTERING_APPLICATION_SINGLETONS} changed={REGISTER_APPLICATION_SINGLETONS}>
                <transition action={REGISTER_APPLICATION_SINGLETONS_COMPLETE} target={INITIALISING_APPLICATION} />
                <transition action={REGISTER_APPLICATION_SINGLETONS_ERROR} target={STARTUP_FAILING} />
              </state>
